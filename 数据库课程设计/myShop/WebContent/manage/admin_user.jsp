    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/myShop/manage/admin_douserselect" method="get">
                    <table class="search-tab">
                        <tr>
                            ...
                            <th width="70">查询用户:</th>
                            <td><input class="common-text" placeholder="搜索用户名关键字" name="keywords" value="${param.keywords}" id="" type="text"></td>
        ...
        <div id="register" class="result-wrap">
            <form action="/myShop/manage/admin_douserdel" id="myform" method="post">
	                        ...
	                        <tr>
	                            ...
	                            <td>
	                              ...
	                              <c:if test="${u.USER_STATUS ==1 }">
	                                <a class="link-del" href="javascript:Delete('你确定要删除用户【${u.USER_NAME}】吗？', '/myShop/manage/admin_douserdel?id=${u.USER_ID}&cpage=${cpage }')">删除</a>
	                              </c:if>
