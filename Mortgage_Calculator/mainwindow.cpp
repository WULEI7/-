    ...
    , ui(new Ui::MainWindow)
{
    ...
    this->setWindowTitle("房贷计算器");//此处设置窗口标题和图标
    //此处初始化界面布局（下拉框均未改动时）
...
//--------------------------------------------------------------------------------------------------------------------------------
        if(ui->comboBox_1->currentIndex()==1)//选择公积金贷款
        {
            if(ui->comboBox_2->currentIndex()==0)//根据单价面积计算
            {
                double input1;//单价
                double input2;//面积
                double input3;//成数
                ...
                else
                {
                    ...
                    if(ui->comboBox_3->currentIndex()==0)//公积金贷款，等额本息
                    {
                        QString result="";
                    ...
                    else if(ui->comboBox_3->currentIndex()==1)//公积金贷款，等额本金
                    {
                        QString result="";
